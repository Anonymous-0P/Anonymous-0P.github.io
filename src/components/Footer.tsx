      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-4 md:mb-0">
            <a href="#" className="font-mono text-xl font-bold text-neon-green">
              <GlitchText text="<CyberPortfolio/>" intensity="low" hoverTriggered />
            </a>
          </div>
          
          <div className="flex items-center space-x-4">
            <a href="#" className="text-foreground/70 hover:text-neon-green transition-colors">
        ...
        <div className="mt-8 pt-6 border-t border-foreground/10 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="text-foreground/60 text-sm font-mono">
            Designed & Built with <span className="text-neon-green">{'</'}</span><span className="text-electric-blue">{'>'}</span>
          </div>
        </div>
